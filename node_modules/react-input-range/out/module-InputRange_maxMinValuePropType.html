...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: InputRange/maxMinValuePropType</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: InputRange/maxMinValuePropType</h1>
...
<article>
    ...
    <h4 class="name" id=".maxMinValuePropType"><span class="type-signature">(static) </span>maxMinValuePropType<span class="signature">(props)</span><span class="type-signature"> &rarr; (nullable) {Error}</span></h4>
