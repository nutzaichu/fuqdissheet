...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: module:InputRange/Label</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: module:InputRange/Label</h1>
...
<article>
    ...
    <h4 class="name" id="module:InputRange/Label"><span class="type-signature"></span>new module:InputRange/Label<span class="signature">(props)</span><span class="type-signature"></span></h4>
